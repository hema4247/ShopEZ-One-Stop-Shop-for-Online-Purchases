...
const fetchProduct = async () =>{
    await axios.get(`http://localhost:8180/fetch-product-details/${id}`).then(
        (response)=>{
...
const buyNow = async() =>{
    await axios.post('http://localhost:8180/buy-product',{userId, name, email, mobile, address, pincode, title: productName, description: productDescription, mainImg: productMainImg, size, quantity: productQuantity, price: productPrice, discount: productDiscount, paymentMethod: paymentMethod, orderDate: new Date()}).then(
        (response)=>{
            alert('Order placed!!');
            navigate('/profile');
        }
...
const handleAddToCart = async() =>{
    await axios.post('http://localhost:8180/add-to-cart', {userId, title: productName, description: productDescription, mainImg: productMainImg, size, quantity: productQuantity, price: productPrice, discount: productDiscount}).then(
        (response)=>{
